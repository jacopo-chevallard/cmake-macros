...
#set ( CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -DLAPACK -g -O0 -cpp -heap-arrays -check all -debug all -ftrapuv  -gen-interfaces -warn interfaces -warn unused -traceback" )
set ( CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -DLAPACK -g -O2 -cpp -xHost -heap-arrays" )
