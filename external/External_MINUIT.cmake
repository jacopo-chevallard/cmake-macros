...
ExternalProject_Add(
  ...
  URL ${CMAKE_CURRENT_SOURCE_DIR}/dependencies/archives/minuit-fortran.tar.gz
  PATCH_COMMAND cp $ENV{CMAKE_MACROS}/external/minuit/CMakeLists.txt <SOURCE_DIR>
  CMAKE_ARGS -DCMAKE_Fortran_COMPILER=${CMAKE_Fortran_COMPILER} -DCMAKE_Fortran_FLAGS=${CMAKE_Fortran_FLAGS} -DCMAKE_INSTALL_PREFIX=<INSTALL_DIR> -DCMAKE_NO_DEFAULT_PATH=${CMAKE_NO_DEFAULT_PATH} -DCMAKE_PARENT_SOURCE_DIR=${CMAKE_CURRENT_SOURCE_DIR}
  )
